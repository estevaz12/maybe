...
- `npm test` - Same as `bin/rails test` (for tools that expect an npm test script)
...
For day-to-day iterations, prefer scoped tests and linters on touched files; reserve the full suite for pre-PR. See [AGENTS.md](AGENTS.md).
